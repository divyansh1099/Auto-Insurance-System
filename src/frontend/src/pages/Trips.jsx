    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden transition-colors duration-200">
      ...
      <div className="relative z-10 space-y-6 p-6">
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/30 dark:border-gray-700/30 p-6 transition-colors duration-200">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 dark:from-cyan-400 dark:via-blue-400 dark:to-purple-400 bg-clip-text text-transparent">Trip History</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1 text-lg">View and analyze all your trips</p>
        </div>
            ...
            <div className="flex gap-2">
              {['all', 'low', 'medium', 'high'].map((filter) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${riskFilter === filter
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center transition-colors duration-200">
              <p className="text-gray-600 dark:text-gray-400 mb-2">No trips found</p>
            ...
            filteredTrips.map((trip) => {
              ...
              return (
                <div key={trip.trip_id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 hover:shadow-md transition-all duration-200">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-semibold text-gray-900 dark:text-white text-sm truncate">{route}</span>
                      </div>
                    ...
                    <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                      <div className={`px-2 py-0.5 rounded-full text-xs font-semibold ${risk.color === 'green' ? 'bg-green-100 text-green-800' :
                          risk.color === 'yellow' ? 'bg-yellow-100 text-yellow-800' :
                            'bg-red-100 text-red-800'
                        }`}>
                        {risk.level}
                      </div>
                      <div className={`text-3xl font-bold leading-none ${risk.color === 'green' ? 'text-green-600' :
        ...
        {/* Pagination */}
        {totalTrips > pageSize && (
          <div className="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg shadow p-4 transition-colors duration-200">
