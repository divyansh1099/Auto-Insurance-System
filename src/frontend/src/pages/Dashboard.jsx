    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden transition-colors duration-200">
      ...
      <div className="relative z-10 space-y-6 p-6">
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/30 dark:border-gray-700/30 p-6 transition-colors duration-200">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300 text-lg">Your driving performance at a glance</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {/* Risk Score Card */}
          <div className="bg-gradient-to-br from-orange-400 to-yellow-500 dark:from-orange-500 dark:to-yellow-600 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-center justify-between mb-2">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-4xl font-bold mb-1">
              {Math.round(summary?.data?.total_savings || totalSavings)}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-colors duration-200">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Driving Performance</h2>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1 space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold dark:text-white">{Math.round(summary?.data?.total_trips || 125)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Miles Driven</span>
                  <span className="font-semibold dark:text-white">{Math.round(summary?.data?.miles_driven || 5520)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Avg Trip Score</span>
                  <span className="font-semibold dark:text-white">{Math.round(summary?.data?.avg_trip_score || 71)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">Score Change</span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-colors duration-200">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Safety Alerts</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              {(recentTrips?.data?.trips || recentTrips?.trips || []) && (recentTrips?.data?.trips || recentTrips?.trips || []).length > 0 ? (
                (recentTrips?.data?.trips || recentTrips?.trips || []).slice(0, 4).map((trip) => {
                  ...
                  return (
                    <div key={trip.trip_id} className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-colors duration-200">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Risk Factor Analysis</h2>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800 rounded-xl shadow-lg p-8 text-white">
          ...
          <div className="mb-4">
            ...
            <div className="w-full bg-blue-500 dark:bg-blue-600 rounded-full h-2">
              <div
