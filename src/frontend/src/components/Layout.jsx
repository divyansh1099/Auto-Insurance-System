      ...
      <div className="fixed inset-y-0 left-0 w-56 bg-white border-r border-gray-200">
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center px-4 py-4 border-b border-gray-200">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900">SmartDrive</h1>
              <p className="text-xs text-gray-500">Telematics</p>
            </div>
          </div>
          ...
          {/* User Card */}
          <div className="px-3 py-3 border-t border-gray-200 relative" ref={userMenuRef}>
            <div 
              className="flex items-center px-2 py-1.5 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors"
            ...
            {/* User Menu Dropdown */}
            {showUserMenu && (
              <div className="absolute bottom-full left-0 right-0 mb-2 mx-3 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                <Link
                  to="/profile"
